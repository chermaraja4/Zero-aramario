        ...
        <Container className="product-container mt-5">
            ...
            <Row>
              ...
              <Col lg={4} className="mt-5 mt-lg-0">
                  ...
                  <div className="pro-tax">2044 day call<span>/ inc. tax</span></div>
        ...
        {/* </Modal.Body> */}
                  ...
                  <div className='pro-des mb-5'>
                    ...
                    <div className="collection">
                        ...
                        <Row>                          
                          ...
                          <Col col={6} className="pro-delivers">
            ...
            <Row className='related my-5 px-3'> 
              <h4 className="mb-3">You may also like</h4>                
                <Col xxl={3} xl={3} lg={4} md={6} sm={6} xs={6} className="py-2 px-2" id="product">
                  <Card>
